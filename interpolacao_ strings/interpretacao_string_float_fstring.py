...
print(f"Valor 2: {valor1:10.2f}")
print(f"Valor 3: {valor1:10.2f}")

#semelhante ao interior, mas preenche casas antes do ponto com zero quando necessário
print(f"Valor 1: {valor1:010.2f}")
print(f"Valor 2: {valor1:010.2f}")
print(f"Valor 3: {valor1:010.2f}")


valor4 = 0.7536

# formação float exibindo em percentual com decimal em 1 digito
